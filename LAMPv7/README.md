...
[LAMPv7 Notes.txt](LAMPv7%20Notes.txt) (click and then select to read the 'Raw' format) may enable more comfortable reading of the steps/changes done to the LAMPv7 server during the adaptation process.
...
After the LAMPv7 VM had been adapted, then import the VM into AWS following instructions on [Importing a VM as an image using VM Import/Export](https://docs.aws.amazon.com/vm-import/latest/userguide/vmimport-image-import.html) and [VM Import](../VMImport).
